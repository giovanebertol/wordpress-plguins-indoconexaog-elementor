...
class BdevsBlog extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Blog', 'conexaog-elementor' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Blog', 'conexaog-elementor' ),
            ]   
        );    
        $this->add_control(
            'heading',
            [
                ...
                'default'     => __( 'LATEST NEWS', 'conexaog-elementor' ),
                'label_block' => true,
            ]
        );  
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( 'More News', 'conexaog-elementor' ),
                'label_block' => true,
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default'     => __( '3', 'conexaog-elementor' ),
                'label_block' => true,
            ]
        );
        $this->add_control(
                    ...
                    <div class="col-lg-4 item text-center">
                        <div class="blog-item wow fadeInUp delay-0-2s black-30-bg ">
                            <div class="content ">                               
                                ...
                                <hr>
                                <span><i class="fa-solid fa-calendar-alt"></i> <?php the_time(get_option( 'date_format' ));?></span>
                                ...
                                <ul class="blog-meta mb-16">
                                    ...
                                    <li>
                                        <i class="fa-solid fa-comment-dots"></i> <?php comments_number( esc_html__('0', 'indoconexaog'), esc_html__('1', 'indoconexaog'), esc_html__('%', 'indoconexaog') ); ?>
                                    </li>
                                </ul>
