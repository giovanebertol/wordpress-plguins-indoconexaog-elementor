...
class BdevsProjectDetails1 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Project Details 1', 'conexaog-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Project Details 1', 'conexaog-elementor' ),
            ]   
        );
        $this->add_control(
            'detail_image',
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( 'VILLA DESIGN', 'conexaog-elementor' ),
                'label_block' => true,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( 'This is text', 'conexaog-elementor' ),
                'label_block' => true,
            ]
        );
