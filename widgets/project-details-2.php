...
class BdevsProjectDetails2 extends \Elementor\Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
            'choose_style',
            [
                'label'     => esc_html__( 'Choose Text Style', 'bdevs-elementor' ),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'style_1'  => esc_html__( 'Two columns text', 'bdevs-elementor' ),
                    'style_2'  => esc_html__( 'One column text', 'bdevs-elementor' ),
                ],
                'default'   => 'style_1',
            ]
        );
        ...
        $this->add_control(
            'text3',
            [
                'label'       => __( 'Content 3:', 'bdevs-elementor' ),
                'type'        => Controls_Manager::WYSIWYG,
                'placeholder' => __( 'Enter your content', 'bdevs-elementor' ),
                'default'     => __( 'This is content', 'bdevs-elementor' ),
                'label_block' => true,
