...
class BdevsProjectDetails3 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'project Details 3', 'bdevs-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Project Details 3', 'bdevs-elementor' ),
            ]   
        );
        $this->add_control(
            'project_info_title',
            [
                'label'       => __( 'Project Info Title:', 'bdevs-elementor' ),
                'type'        => Controls_Manager::TEXTAREA,
                'placeholder' => __( 'Enter your text', 'bdevs-elementor' ),
                'default'     => __( 'ABOUT THIS PROJECT', 'bdevs-elementor' ),
                'label_block' => true,
            ]
        );
        $this->add_control(
            'project_info',
            [
                'label'       => __( 'Project Info:', 'bdevs-elementor' ),
                'type'        => Controls_Manager::TEXTAREA,
                'placeholder' => __( 'Enter your text', 'bdevs-elementor' ),
                'default'     => __( 'This is info', 'bdevs-elementor' ),
                'label_block' => true,
            ]
        );
        $this->add_control(
            'share_title',
            [
                'label'       => __( 'Share Title:', 'bdevs-elementor' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __( 'Enter your text', 'bdevs-elementor' ),
                'default'     => __( 'Share: ', 'bdevs-elementor' ),
                'label_block' => true,
            ]
        );
        $this->add_control(
            'type_title',
            [
                'label'       => __( 'Type Title:', 'bdevs-elementor' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __( 'Enter your text', 'bdevs-elementor' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( 'MODERN INTERIOR DESIGN', 'bdevs-elementor' ),
                'label_block' => true,
            ]
        );
        $this->add_control(
            'text1',
            [
                'label'       => __( 'Content 1:', 'bdevs-elementor' ),
        ...
        $this->add_control(
            'text2',
            [
                'label'       => __( 'Content 2:', 'bdevs-elementor' ),
                'type'        => Controls_Manager::WYSIWYG,
                'placeholder' => __( 'Enter your content', 'bdevs-elementor' ),
                'default'     => __( 'This is content', 'bdevs-elementor' ),
                'label_block' => true,
        ...
        **/
        ...
        $this->add_control(
            'show_share',
            [
                'label'   => esc_html__( 'Show Share', 'bdevs-elementor' ),
        ...
        $this->add_control(
            'show_types',
            [
                'label'   => esc_html__( 'Show Types', 'bdevs-elementor' ),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        ); 
                    ...
                    <div class="col-lg-9 right">
                        ...
                        <ul class="mb-16 detail-list-text">
                            <?php foreach ( $settings['tabs'] as $item ) :  ?>
                                ...
                                <li><i class="fa fa-check"></i> <?php print wp_kses_post($item['item']); ?></li>
                                <?php } ?>
                            <?php endforeach; ?>
                        </ul>
