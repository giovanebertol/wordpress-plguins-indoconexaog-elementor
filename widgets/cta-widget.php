	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __( 'SUBSCRIBE', 'bdevs-elementor' ),
                'label_block' => true,
            ]
        );
		$this->add_control(
            ...
            [
                ...
                'fields' => [                   
                    [
                        ...
                        'dynamic' => [ 'active' => true ],
                        'options'   => [
                            'style_1'  => esc_html__( 'Default', 'bdevs-elementor' ),
                            'style_2'  => esc_html__( 'White', 'bdevs-elementor' ),
                        ],
                        'default'   => 'style_1',
                    ],
                    [
                        ...
                        'type'        => Controls_Manager::TEXT,
                        'dynamic'     => [ 'active' => true ],
                        'default'     => esc_html__( 'Want some design' , 'bdevs-elementor' ),
                        'label_block' => true,
                    ],
