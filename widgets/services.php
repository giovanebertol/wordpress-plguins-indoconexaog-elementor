    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Background Color', 'bdevs-elementor' ),
                'default'     => __( '#101010', 'bdevs-elementor' ),
                'label_block' => true,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::COLOR,
                'placeholder' => __( 'Text Color', 'bdevs-elementor' ),
                'default'     => __( '#fff', 'bdevs-elementor' ),
                'label_block' => true,
                'condition' => [
                    'choose_style' => ['style_1'],
                ]
        ...
        $this->add_control(
            'button_color',
            [
                'label'       => __( 'Button Border Color:', 'bdevs-elementor' ),
                'type'        => Controls_Manager::COLOR,
                'placeholder' => __( 'Button Border Color', 'bdevs-elementor' ),
                'default'     => __( '#ffffff', 'bdevs-elementor' ),
                'label_block' => true,
                'condition' => [
                    'choose_style' => ['style_1'],
                ]
        ...
        $this->add_control(
            'arrow_color',
            [
                'label'       => __( 'Button Arrow Color:', 'bdevs-elementor' ),
                'type'        => Controls_Manager::COLOR,
                'placeholder' => __( 'Button Arrow Color', 'bdevs-elementor' ),
                'default'     => __( '#141414', 'bdevs-elementor' ),
                'label_block' => true,
                'condition' => [
                    'choose_style' => ['style_1'],
                ]
        ...
        $this->add_control(
            'arrow_right',
            [
                'label'       => __( 'Arrow Right:', 'bdevs-elementor' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __( 'Enter your arrow right', 'bdevs-elementor' ),
                'default'     => __( 'fa-long-arrow-right', 'bdevs-elementor' ),
                'label_block' => true,
            ]
        );
