...
class BdevsSlider2 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Slider 2', 'conexaog-elementor' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Slider 2', 'conexaog-elementor' ),
            ]   
        ); 
        $this->add_control(
            'tabs',
            [
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'dynamic'     => [ 'active' => true ],
                        'default'     => esc_html__( 'INTERIOR ARCHITECTURE' , 'conexaog-elementor' ),
                        'label_block' => true,
                    ],
                    [
                        'name'        => 'description',
                        ...
                        'type'        => Controls_Manager::TEXTAREA,
                        'dynamic'     => [ 'active' => true ],
                        'default'     => esc_html__( 'Where creativity meets functionality' , 'conexaog-elementor' ),
                        'label_block' => true,
                    ],
                    [
                        'name'        => 'search_placeholder',
                        'label'       => esc_html__( 'Search Placeholder:', 'conexaog-elementor' ),
                        'type'        => Controls_Manager::TEXTAREA,
                        'dynamic'     => [ 'active' => true ],
                        'default'     => esc_html__( 'Type to search...' , 'conexaog-elementor' ),
                        'label_block' => true,
                    ],
                    [
                        'name'        => 'search_icon',
                        'label'       => esc_html__( 'Search Icon:', 'conexaog-elementor' ),
                        'type'        => Controls_Manager::TEXTAREA,
                        'dynamic'     => [ 'active' => true ],
                        'default'     => esc_html__( 'fa-search' , 'conexaog-elementor' ),
                        'label_block' => true,
                    ],
                ],
            ]
        ...
        **/
        ...
        $this->add_control(
            'show_search',
            [
                'label'   => esc_html__( 'Show Search Form', 'conexaog-elementor' ),
